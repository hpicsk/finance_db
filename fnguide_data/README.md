...
This table is `data/vintages.csv` in prose; the file is the source of truth, and
...
**`data/vintages.csv`** — one row per sheet, with the build stamp, the `기간` range,
...
assumed: of their 4,126 codes, 107 appear in `kr_delisted/data/delisting_calendar.csv`
...
4,126 codes appear in `kr_delisted/data/delisting_calendar.csv`: 12 delisted *after*
